...
Delete(){
    ...
    #Re-asking to delete (confirmation)
    ...
    then
        echo -e "\033[0;31mERROR : The titles does not match !\033[0;0m"
        exit 1 
    fi
    ...
    then
        ...
        #If the project is not in the project folder
    ...
    #Deleting nginx config files & folder insite /var/www/html
